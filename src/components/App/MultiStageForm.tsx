  ...
  return (
    <>
      ...
      <Text>
        ...
        <span style={{ color: "#400050", fontWeight: "bold" }}>
          3,000,000 NGN
        </span>
      </Text>
      <Flex mt={"8"}>
      ...
      <Text mt={4} color={"#000000"}>
        How long do you want to loan for? <span>(in months)</span>{" "}
      </Text>
      <Box pt={6} pb={2}>
        <Slider
          max={72}
        ...
        >
          ...
          <SliderMark value={72} {...labelStyles} ml={-16} w="full">
            72 Months
          </SliderMark>
          <SliderMark
            value={sliderValue}
      ...
      >
        <Box mb="4%" ml={-2}>
          <HStack justify={"space-between"}>
            <IconButton
                aria-label="previous"
                icon={<BsArrowLeft color="#400050" size="20px" />}
                variant="ghost"
                onClick={() => {
                    setStep(step - 1);
                }}
        ...
        <Text size={"18"} fontWeight={"500"} color={"#979797"}>
          STEP {step} of 3
        </Text>
